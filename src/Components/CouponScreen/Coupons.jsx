...
const Coupons = ({discount}) => {
  ...
  return (
    <View style={{alignItems: 'center', width: '100%', marginTop:10}}>
      <ImageBackground
        style={{width: 345, height: 90, display: 'flex', flexDirection: 'row'}}
        resizeMode="cover"
        source={require('../../assets/Images/CouponCard.png')}>
        <View
          style={{
            height: '100%',
            width: '30%',
          ...
          <Image
            style={{height: 33, width: 38, resizeMode: 'contain'}}
        ...
        <View
          ...
          <View>
            ...
            <Text
              ...
              Save {discount}% on this consultation
            </Text>
            <Text
              style={{
                fontFamily: 'Montserrat-Medium',
